...
define("dijit/form/Select", "dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/i18n dojo/keys dojo/_base/lang dojo/on dojo/sniff ./_FormSelectWidget ../_HasDropDown ../DropDownMenu ../MenuItem ../MenuSeparator ../Tooltip ../_KeyNavMixin ../registry dojo/text!./templates/Select.html dojo/i18n!./nls/validate".split(" "), function(h, e, r, k, c, t, l, f, m, g, u, v, w, n, x, d, y, z, A) {
    function p(a) {
        return function(b) {
            this._isLoaded ? this.inherited(a, arguments) : this.loadDropDown(f.hitch(this,
                a, b))
        }
    }
    var q = e("dijit.form._SelectMenu", w, {
        autoFocus: !0,
    ...
    c = e("dijit.form.Select" + (g("dojo-bidi") ? "_NoBidi" : ""), [u, v, y], {
        ...
        _fillContent: function() {
            ...
            if (this.options.length && !this.value && this.srcNodeRef) {
                ...
                this._set("value", this.options[0 <=
                    a ? a : 0].value)
            }
            this.dropDown = new q({
                id: this.id + "_menu",
    ...
    g("dojo-bidi") && (c = e("dijit.form.Select", c, {
        _setDisplay: function(a) {
            this.inherited(arguments);

...
define("dijit/form/Form", "dojo/_base/declare dojo/dom-attr dojo/_base/kernel dojo/sniff ../_Widget ../_TemplatedMixin ./_FormMixin ../layout/_ContentPaneResizeMixin".split(" "), function(c, d, e, f, g, h, k, l) {
    return c("dijit.form.Form", [g, h, k, l], {
        name: "",
        action: "",
        method: "",
        encType: "",
        ...
        _onSubmit: function(a) {
            ...
            if (this.execute != b.execute || this.onExecute != b.onExecute) e.deprecated("dijit.form.Form:execute()/onExecute() are deprecated. Use onSubmit() instead.", "", "2.0"), this.onExecute(), this.execute(this.getValues());

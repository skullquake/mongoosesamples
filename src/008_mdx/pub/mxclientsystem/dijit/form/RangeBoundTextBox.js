...
define("dijit/form/RangeBoundTextBox", ["dojo/_base/declare", "dojo/i18n", "./MappedTextBox", "dojo/i18n!./nls/validate"], function(c, d, e) {
    return c("dijit.form.RangeBoundTextBox", e, {
        rangeMessage: "",
        rangeCheck: function(b, a) {
        ...
        _isDefinitelyOutOfRange: function() {
            ...
            if (null == b) return !1;
            var a = !1;
            "min" in this.constraints &&
                (a = this.constraints.min, a = 0 > this.compare(b, "number" == typeof a && 0 <= a && 0 != b ? 0 : a));
        ...
        getErrorMessage: function(b) {
            ...
            return null == a || "" === a || "number" == typeof a &&
                isNaN(a) || this.isInRange(b) ? this.inherited(arguments) : this.rangeMessage
        },

...
define("dijit/form/_FormSelectWidget", "dojo/_base/array dojo/_base/Deferred dojo/aspect dojo/data/util/sorter dojo/_base/declare dojo/dom dojo/dom-class dojo/_base/kernel dojo/_base/lang dojo/query dojo/when dojo/store/util/QueryResults ./_FormValueWidget".split(" "), function(d, h, k, m, n, p, q, l, e, r, t, u, v) {
    return n("dijit.form._FormSelectWidget", v, {
        multiple: !1,
        options: null,
        store: null,
        ...
        getOptions: function(a) {
            var c = this.options || [];
            if (null == a) return c;
            if (e.isArrayLike(a)) return d.map(a, "return this.getOptions(item);", this);
            e.isString(a) && (a = {
                value: a
            });
        ...
        _deprecatedSetStore: function(a, c, b) {
            ...
            b = b || {};
            if (g !== a) {
                for (var f; f = this._notifyConnections.pop();) f.remove();
                a.get || (e.mixin(a, {
                    _oldAPI: !0,
                    get: function(a) {
                        var b = new h;
                ...
                }), a.getFeatures()["dojo.data.api.Notification"] && (this._notifyConnections = [k.after(a,
                    "onNew", e.hitch(this, "_onNewItem"), !0), k.after(a, "onDelete", e.hitch(this, "_onDeleteItem"), !0), k.after(a, "onSet", e.hitch(this, "_onSetItem"), !0)]));
                this._set("store", a)
            }
            ...
            a && a.query &&
                (this._loadingStore = !0, this.onLoadDeferred = new h, this._queryRes = a.query(this.query, this.queryOptions), t(this._queryRes, e.hitch(this, function(f) {
                    if (this.sortByLabel && !b.sort && f.length)
                        if (a.getValue) f.sort(m.createSortFunction([{
                            attribute: a.getLabelAttributes(f[0])[0]
                        }], a));
                        else {
                    ...
                    this._queryRes.observe && (this._observeHandle = this._queryRes.observe(e.hitch(this,
                        function(a, b, c) {
        ...
        _loadChildren: function() {
            this._loadingStore || (d.forEach(this._getChildren(),
                function(a) {
                    a.destroyRecursive()
        ...
        _updateSelection: function() {
            ...
            if (a && a[0]) {
                ...
                d.forEach(this._getChildren(), function(b) {
                    ...
                    b.domNode.setAttribute("aria-selected",
                        e ? "true" : "false")
                }, this)
            }
        },
        ...
        _getOptionObjForItem: function(a) {
            var c = this.store,
                b = this.labelAttr && this.labelAttr in a ? a[this.labelAttr] : c.getLabel(a);
            return {
                value: b ? c.getIdentity(a) : null,
                label: b,
                item: a
            }
        },
        ...
        _fillContent: function() {
            this.options || (this.options = this.srcNodeRef ? r("\x3e *", this.srcNodeRef).map(function(a) {
                return "separator" === a.getAttribute("type") ? {
                    ...
                    value: a.getAttribute("data-" + l._scopeName + "-value") || a.getAttribute("value"),
                    label: String(a.innerHTML),
                    selected: a.getAttribute("selected") || !1,
                    disabled: a.getAttribute("disabled") || !1
                }
            }, this) : []);
            this.value ? this.multiple && "string" == typeof this.value && this._set("value",
                this.value.split(",")) : this._set("value", this._getValueFromOpts())
        },
        postCreate: function() {
            this.inherited(arguments);
            k.after(this, "onChange", e.hitch(this, "_updateSelection"));
            var a = this.store;
            a && (a.getIdentity || a.getFeatures()["dojo.data.api.Identity"]) && (this.store = null, this._deprecatedSetStore(a, this._oValue, {
                query: this.query,

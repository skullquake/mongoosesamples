...
define("dijit/form/MultiSelect", "dojo/_base/array dojo/_base/declare dojo/dom-geometry dojo/sniff dojo/query ./_FormValueWidget dojo/NodeList-dom".split(" "), function(f, h, k, g, c, d) {
    d = h("dijit.form.MultiSelect" + (g("dojo-bidi") ? "_NoBidi" : ""), d, {
        size: 7,
        baseClass: "dijitMultiSelect",
        templateString: "\x3cselect multiple\x3d'multiple' ${!nameAttrSetting} data-dojo-attach-point\x3d'containerNode,focusNode' data-dojo-attach-event\x3d'onchange: _onChange'\x3e\x3c/select\x3e",
        addSelected: function(b) {
    ...
    g("dojo-bidi") && (d = h("dijit.form.MultiSelect", d, {
        addSelected: function(b) {
            b.getSelected().forEach(function(a) {

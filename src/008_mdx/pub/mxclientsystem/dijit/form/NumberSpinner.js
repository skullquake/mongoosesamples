...
define("dijit/form/NumberSpinner", ["dojo/_base/declare", "dojo/keys", "./_Spinner", "./NumberTextBox"], function(h, c, k, l) {
    return h("dijit.form.NumberSpinner", [k, l.Mixin], {
        ...
        _onKeyDown: function(a) {
            if (!(this.disabled ||
                    this.readOnly || a.keyCode != c.HOME && a.keyCode != c.END || a.ctrlKey || a.altKey || a.metaKey || "undefined" == typeof this.get("value"))) {

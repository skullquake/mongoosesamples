...
define("dijit/form/_DateTimeTextBox", "dojo/date dojo/date/locale dojo/date/stamp dojo/_base/declare dojo/_base/lang ./RangeBoundTextBox ../_HasDropDown dojo/text!./templates/DropDownBox.html".split(" "), function(g, h, f, k, e, l, m, n) {
    new Date("X");
    return k("dijit.form._DateTimeTextBox", [l, m], {
        templateString: n,
        hasDownArrow: !0,
        cssStateNodes: {
        ...
        parse: function(a, b) {
            return this.dateLocaleModule.parse(a, b) || (this._isEmpty(a) ? null :
                void 0)
        },
        ...
        _setConstraintsAttr: function(a) {
            ...
            this.inherited(arguments);
            this._unboundedConstraints = e.mixin({}, this.constraints, {
                min: null,
                max: null
            })
        },
        ...
        openDropDown: function(a) {
            ...
            var b = e.isString(this.popupClass) ? e.getObject(this.popupClass, !1) : this.popupClass,
                c = this,
                d = this.get("value");
            this.dropDown = new b({
                onChange: function(a) {
                ...
                value: d,
                textDir: c.textDir,
                currentFocus: this._isInvalidDate(d) ? this.dropDownDefaultValue : d,

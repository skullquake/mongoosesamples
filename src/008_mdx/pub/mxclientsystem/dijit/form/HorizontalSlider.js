...
define("dijit/form/HorizontalSlider", "dojo/_base/array dojo/_base/declare dojo/dnd/move dojo/_base/fx dojo/dom-geometry dojo/dom-style dojo/keys dojo/_base/lang dojo/sniff dojo/dnd/Moveable dojo/dnd/Mover dojo/query dojo/mouse dojo/on ../_base/manager ../focus ../typematic ./Button ./_FormValueWidget ../_Container dojo/text!./templates/HorizontalSlider.html".split(" "), function(r, f, g, t, h, u, e, l, v, w, m, x, y, z, A, n, p, E, B, C, D) {
    var q = f("dijit.form._SliderMover", m, {
    ...
    g = f("dijit.form.HorizontalSlider", [B, C], {
        templateString: D,
        value: 0,
        showButtons: !0,
        minimum: 0,
        ...
        pageIncrement: 2,
        clickSelect: !0,
        slideDuration: A.defaultDuration,
        _setIdAttr: "",
        ...
        _onKeyDown: function(a) {
            if (!(this.disabled ||
                    this.readOnly || a.altKey || a.ctrlKey || a.metaKey)) {
                switch (a.keyCode) {
                    case e.HOME:
                    ...
                    case e.END:
                        ...
                        break;
                    case this._descending || this.isLeftToRight() ? e.RIGHT_ARROW:
                        e.LEFT_ARROW: case !1 === this._descending ? e.DOWN_ARROW : e.UP_ARROW: case !1 === this._descending ? e.PAGE_DOWN : e.PAGE_UP: this.increment(a);
                        break;
                    case this._descending || this.isLeftToRight() ? e.LEFT_ARROW:
                        e.RIGHT_ARROW: case !1 === this._descending ? e.UP_ARROW : e.DOWN_ARROW: case !1 === this._descending ?
                            e.PAGE_UP : e.PAGE_DOWN: this.decrement(a);
                        break;
                    default:
                        return
                }
        ...
        _onBarClick: function(a) {
            if (!this.disabled && !this.readOnly && this.clickSelect) {
                ...
                a.stopPropagation();
                a.preventDefault();
                var b = h.position(this.sliderBarContainer, !0),
                    c = a[this._mousePixelCoord] -
                    b[this._startingPixelCoord];
        ...
        _setValueAttr: function(a, b) {
            ...
            this.focusNode.setAttribute("aria-valuenow",
                a);
            ...
            if (b && 0 < this.slideDuration && d.style[this._progressPixelSize]) {
                var f = this,
                    ...
                    k = this.slideDuration * (c - h / 100);
                0 != k && (0 > k && (k = 0 - k), g[this._progressPixelSize] = {
                    start: h,
                    end: 100 * c,
                    units: "%"
                }, this._inProgressAnim = t.animateProperty({
                    node: d,
                    duration: k,
        ...
        _bumpValue: function(a, b) {
            if (!(this.disabled || this.readOnly || this.maximum <= this.minimum)) {
                var c = u.getComputedStyle(this.sliderBarContainer),
                    d = h.getContentBox(this.sliderBarContainer, c),
        ...
        _onClkDecBumper: function() {
            this._onClkBumper(!1 ===
                this._descending ? this.maximum : this.minimum)
        },
        ...
        postCreate: function() {
            ...
            this._movable = new w(this.sliderHandle, {
                mover: a
            });
            this._layoutHackIE7()
        },

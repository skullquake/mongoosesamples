...
define("dijit/form/TextBox", "dojo/_base/declare dojo/dom-construct dojo/dom-style dojo/_base/kernel dojo/_base/lang dojo/on dojo/sniff ./_FormValueWidget ./_TextBoxMixin dojo/text!./templates/TextBox.html ../main".split(" "), function(d, k, l, e, m, f, b, c, g, n, p) {
    c = d("dijit.form.TextBox" + (b("dojo-bidi") ? "_NoBidi" : ""), [c, g], {
        templateString: n,
        ...
        _buttonInputDisabled: b("ie") ? "disabled" : "",
                ...
                try {
                    ...
                    if (a) {
                        ...
                        if (h) {
                            ...
                            if (b)
                                for (a = 0; a < b.length; a++) b[a].style.fontFamily = h
                        }
                    }
                } catch (q) {}
            })
        ...
        _setPlaceHolderAttr: function(a) {
            ...
            this._phspan || (this._attachPoints.push("_phspan"), this._phspan = k.create("span", {
                className: "dijitPlaceHolder dijitInputField"
            }, this.textbox, "after"), this.own(f(this._phspan, "mousedown", function(a) {
                a.preventDefault()
        ...
        getDisplayedValue: function() {
            e.deprecated(this.declaredClass + "::getDisplayedValue() is deprecated. Use get('displayedValue') instead.",
                "", "2.0");
    ...
    b("dojo-bidi") && (c = d("dijit.form.TextBox", c, {
        _setPlaceHolderAttr: function(a) {
            this.inherited(arguments);

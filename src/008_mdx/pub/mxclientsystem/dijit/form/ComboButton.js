...
define("dijit/form/ComboButton", "dojo/_base/declare dojo/keys ../focus ./DropDownButton dojo/text!./templates/ComboButton.html ../a11yclick".split(" "), function(d, c, b, e, f) {
    return d("dijit.form.ComboButton", e, {
        templateString: f,
        _setIdAttr: "",
        ...
        _focusedNode: null,
        _onButtonKeyDown: function(a) {
            a.keyCode ==
                c[this.isLeftToRight() ? "RIGHT_ARROW" : "LEFT_ARROW"] && (b.focus(this._popupStateNode), a.stopPropagation(), a.preventDefault())
        },
        _onArrowKeyDown: function(a) {
            a.keyCode == c[this.isLeftToRight() ? "LEFT_ARROW" : "RIGHT_ARROW"] && (b.focus(this.titleNode), a.stopPropagation(), a.preventDefault())
        },
        focus: function(a) {

//>>built
define("dijit/layout/ContentPane", "dojo/_base/kernel dojo/_base/lang ../_Widget ../_Container ./_ContentPaneResizeMixin dojo/string dojo/html dojo/_base/array dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-construct dojo/_base/xhr dojo/i18n dojo/when dojo/i18n!../nls/loading".split(" "), function(g, b, n, p, q, k, l, e, r, h, t, z, u, v, w, x) {
    return r("dijit.layout.ContentPane", [n, p, q], {
        href: "",
        content: "",
        extractContent: !1,
        parseOnLoad: !0,
        parserScope: g._scopeName,
        preventCache: !1,
        preload: !1,
        refreshOnShow: !1,
        ...
        stopParser: !0,
        template: !1,
        markupFactory: function(a, d, c) {
            var b = new c(a, d);
            return !b.href &&
                b._contentSetter && b._contentSetter.parseDeferred && !b._contentSetter.parseDeferred.isFulfilled() ? b._contentSetter.parseDeferred.then(function() {
                    return b
                }) : b
        },
        create: function(a, d) {
            if (!(a && a.template || !d || "href" in a || "content" in a)) {
                d = t.byId(d);
                for (var c = d.ownerDocument.createDocumentFragment(); d.firstChild;) c.appendChild(d.firstChild);
                a = b.delegate(a, {
                    content: c
                })
            }
        ...
        postMixInProperties: function() {
            ...
            var a = w.getLocalization("dijit", "loading", this.lang);
        ...
        _setHrefAttr: function(a) {
            ...
            this.onLoadDeferred.then(b.hitch(this,
                "onLoad"));
            this._set("href", a);
        ...
        _load: function() {
            ...
            var c = this._xhrDfd = (this.ioMethod || v.get)(d),
                f;
            c.then(function(c) {
                f = c;
                try {
        ...
        _onLoadHandler: function(a) {
            ...
            try {
                ...
                console.error("Error " + this.widgetId + " running custom onLoad code: " + d.message)
            }
        },
        ...
        destroyDescendants: function(a) {
            ...
            e.forEach(this.getChildren(), function(c) {
                c.destroyRecursive ? c.destroyRecursive(a) : c.destroy && c.destroy(a);
                c._destroyed = !0
            });
            b && (e.forEach(b.parseResults, function(c) {
                c._destroyed || (c.destroyRecursive ? c.destroyRecursive(a) : c.destroy && c.destroy(a), c._destroyed = !0)
        ...
        _setContent: function(a, d) {
            ...
            c && c instanceof l._ContentSetter || (c = this._contentSetter = new l._ContentSetter({
                ...
                _onError: b.hitch(this, this._onError),
                onContentError: b.hitch(this, function(a) {
                    a = this.onContentError(a);
                    try {
                        this.containerNode.innerHTML = a
                    } catch (m) {
                        console.error("Fatal " + this.id + " could not change content due to " + m.message, m)
                    }
                })
            }));
            var f = b.mixin({
                ...
                f = c.set(b.isObject(a) && a.domNode ? a.domNode : a, f),
                e = this;
            return x(f && f.then ? f : c.parseDeferred, function() {
        ...
        _onError: function(a, b, c) {
            ...
            c ? console.error(c, b) : a && this._setContent(a,
                !0)
        },
        onLoad: function() {},
        onUnload: function() {},

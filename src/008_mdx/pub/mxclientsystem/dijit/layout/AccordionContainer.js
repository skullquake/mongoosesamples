...
define("dijit/layout/AccordionContainer", "require dojo/_base/array dojo/_base/declare dojo/_base/fx dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/keys dojo/_base/lang dojo/sniff dojo/topic ../focus ../_base/manager dojo/ready ../_Widget ../_Container ../_TemplatedMixin ../_CssStateMixin ./StackContainer ./ContentPane dojo/text!./templates/AccordionButton.html ../a11yclick".split(" "), function(w, n, f, x, y, p, z, g, h, e, k, m, q, A, B, C, t, G, D, u, E, H, F) {
    function v(a, b) {
        a.resize ?
            a.resize(b) : h.setMarginBox(a.domNode, b)
    }
    q = f("dijit.layout._AccordionButton", [t, D, u], {
        templateString: F,
        label: "",
        _setLabelAttr: {
            node: "titleTextNode",
        ...
        _setSelectedAttr: function(a) {
            ...
            this.focusNode.setAttribute("aria-selected",
                a ? "true" : "false");
            this.focusNode.setAttribute("tabIndex", a ? "0" : "-1")
        }
    });
    m("dojo-bidi") && q.extend({
    ...
    var r = f("dijit.layout._AccordionInnerContainer" + (m("dojo-bidi") ? "_NoBidi" : ""), [t, u], {
        baseClass: "dijitAccordionInnerContainer",
        isLayoutContainer: !0,
        buildRendering: function() {
            this.domNode =
                g.place("\x3cdiv class\x3d'" + this.baseClass + "' role\x3d'presentation'\x3e", this.contentWidget.domNode, "after");
            var a = this.contentWidget,
                b = k.isString(this.buttonWidget) ? k.getObject(this.buttonWidget) : this.buttonWidget;
            ...
            this.containerNode = g.place("\x3cdiv class\x3d'dijitAccordionChildWrapper' role\x3d'tabpanel' style\x3d'display:none'\x3e",
                this.domNode);
        ...
        _setSelectedAttr: function(a) {
            ...
            if (a && (a = this.contentWidget, a.onSelected)) a.onSelected()
        },
        startup: function() {
    ...
    m("dojo-bidi") && (r = f("dijit.layout._AccordionInnerContainer", r, {
        postCreate: function() {
            this.inherited(arguments);
            var a = this.button;
    ...
    f = f("dijit.layout.AccordionContainer", E, {
        ...
        startup: function() {
            this._started || (this.inherited(arguments), this.selectedChildWidget &&
                this.selectedChildWidget._wrapperWidget.set("selected", !0))
        },
        layout: function() {
            var a = this.selectedChildWidget;
            if (a) {
                var b = a._wrapperWidget.domNode,
                    c = h.getMarginExtents(b),
                    b = h.getPadBorderExtents(b),
                    d = a._wrapperWidget.containerNode,
                    l = h.getMarginExtents(d),
                    d = h.getPadBorderExtents(d),
                    f = this._contentBox,
                    e = 0;
                ...
                this._containerContentBox = {
                    ...
                    w: this._contentBox.w - c.w - b.w - l.w - d.w
                };
        ...
        _transition: function(a, b, c) {
            ...
            if (c) {
                var e = a._wrapperWidget.containerNode,
                    g = b._wrapperWidget.containerNode;
                c = a._wrapperWidget.containerNode;
                a = h.getMarginExtents(c);
                c = h.getPadBorderExtents(c);
                var k = a.h + c.h;
                g.style.height = d._verticalSpace - k + "px";
                this._animation = new x.Animation({
                    node: e,
                    duration: this.duration,
                    curve: [1, this._verticalSpace - k - 1],
        ...
        _onKeyDown: function(a, b) {
            if (!this.disabled && !a.altKey && (b || a.ctrlKey)) {
                var c = a.keyCode;
                if (b && (c == e.LEFT_ARROW || c == e.UP_ARROW) || a.ctrlKey && c == e.PAGE_UP) this._adjacent(!1)._buttonWidget._onTitleClick(), a.stopPropagation(), a.preventDefault();
                else if (b && (c == e.RIGHT_ARROW || c == e.DOWN_ARROW) || a.ctrlKey && (c == e.PAGE_DOWN || c == e.TAB)) this._adjacent(!0)._buttonWidget._onTitleClick(), a.stopPropagation(), a.preventDefault()
            }
        }
    });

...
define("dijit/layout/utils", ["dojo/_base/array", "dojo/dom-class", "dojo/dom-geometry", "dojo/dom-style", "dojo/_base/lang"], function(h, m, f, k, d) {
    ...
    var n = {
        marginBox2contentBox: function(a, b) {
            var c = k.getComputedStyle(a),
                d = f.getMarginExtents(a, c),
                g = f.getPadBorderExtents(a, c);
            return {
                l: k.toPixelValue(a, c.paddingLeft),
                t: k.toPixelValue(a, c.paddingTop),
                w: b.w - (d.w + g.w),
                h: b.h - (d.h + g.h)
            }
        },

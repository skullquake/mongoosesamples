...
define("dijit/popup", "dojo/_base/array dojo/aspect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/keys dojo/_base/lang dojo/on ./place ./BackgroundIframe ./Viewport ./main dojo/touch".split(" "), function(w, x, e, y, z, r, k, p, A, t, m, u, v, B, C, D) {
    ...
    e = e(null, {
        ...
        _repositionAll: function() {
            if (this._firstAroundNode) {
                var a = this._firstAroundPosition,
                    b = k.position(this._firstAroundNode, !0),
                    c = b.x - a.x,
                    a = b.y - a.y;
                if (c || a)
        ...
        _createWrapper: function(a) {
            ...
            }, a.ownerDocumentBody), b.appendChild(c), c = c.style, c.display = "", c.visibility = "", c.position = "", c.top = "0px", a._popupWrapper = b, x.after(a, "destroy", E, !0), "ontouchend" in document && u(b, "touchend", function(a) {
        ...
        open: function(a) {
            for (var b = this._stack, c = a.popup, d = c.domNode, f = a.orient || ["below", "below-alt", "above", "above-alt"], F = a.parent ? a.parent.isLeftToRight() :
                    k.isBodyLtr(c.ownerDocument), h = a.around, q = a.around && a.around.id ? a.around.id + "_dropdown" : "popup_" + this._idGen++; b.length && (!a.parent || !y.isDescendant(a.parent.domNode, b[b.length - 1].widget.domNode));) this.close(b[b.length - 1].widget);
            var g = this.moveOffScreen(c);
            c.startup && !c._started && c.startup();
            var l, n = k.position(d);
            if ("maxHeight" in a && -1 != a.maxHeight) l = a.maxHeight || Infinity;
            else {
                l = C.getEffectiveBox(this.ownerDocument);
                var e = h ? k.position(h, !1) : {
                    y: a.y - (a.padding || 0),
                    h: 2 * (a.padding || 0)
                };
                l = Math.floor(Math.max(e.y,
                    l.h - (e.y + e.h)))
            }
            n.h > l && (n = p.getComputedStyle(d), p.set(g, {
                overflowY: "scroll",
                height: l + "px",
                border: n.borderLeftWidth + " " + n.borderLeftStyle + " " + n.borderLeftColor
            }), d._originalStyle = d.style.cssText, d.style.border = "none");
            z.set(g, {
                id: q,
                style: {
                    zIndex: this._beginZIndex + b.length
                },
                "class": "dijitPopup " + (c.baseClass || c["class"] || "").split(" ")[0] + "Popup",
                dijitPopupParent: a.parent ? a.parent.id : ""
            });
            0 == b.length && h && (this._firstAroundNode = h, this._firstAroundPosition = k.position(h, !0), this._aroundMoveListener = setTimeout(m.hitch(this,
                "_repositionAll"), 50));
            ...
            d.push(u(g, "keydown", m.hitch(this, function(b) {
                if (b.keyCode == t.ESCAPE && a.onCancel) b.stopPropagation(), b.preventDefault(), a.onCancel();
                else if (b.keyCode == t.TAB && (b.stopPropagation(), b.preventDefault(), (b = this.getTopPopup()) && b.onCancel)) b.onCancel()
            })));

...
define("dijit/Editor", "require dojo/_base/array dojo/_base/declare dojo/Deferred dojo/i18n dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/keys dojo/_base/lang dojo/sniff dojo/string dojo/topic ./_Container ./Toolbar ./ToolbarSeparator ./layout/_LayoutWidget ./form/ToggleButton ./_editor/_Plugin ./_editor/plugins/EnterKeyHandling ./_editor/html ./_editor/range ./_editor/RichText ./main dojo/i18n!./_editor/nls/commands".split(" "), function(w, l, q, x, y, z, t, u, r, d, h, f, A, B, J, C, D, E, F, m,
    ...
    q = q("dijit.Editor", H, {
        ...
        constructor: function() {
            ...
            if (f("ie") || f("trident") || f("edge")) this.events.push("onBeforeDeactivate"), this.events.push("onBeforeActivate")
        },
        ...
        postCreate: function() {
            ...
            f("webkit") && r.set(this.domNode,
                "KhtmlUserSelect", "none")
        },
        startup: function() {
            this.inherited(arguments);
            this.toolbar || (this.toolbar = new C({
        ...
        addPlugin: function(a, b) {
            ...
            if (!c.setEditor) {
                ...
                if (!p.plugin) try {
                    ...
                    throw Error(this.id +
                        ": cannot find plugin [" + c.name + "]");
                }
                if (!p.plugin) throw Error(this.id + ": cannot find plugin [" + c.name + "]");
                a = p.plugin
            }
        ...
        _onIEMouseDown: function(a) {
            var b, c = this.document.body,
                ...
                g = c.offsetHeight,
                h = c.offsetLeft;
            /^rtl$/i.test(c.dir || "") ? d < f && a.x > d && a.x < f && (b = !0) : a.x < k && a.x > h && (b = !0);
        ...
        _clipboardCommand: function(a) {
            var b;
            try {
                if (b = this.document.execCommand(a, !1, null), f("webkit") && !b) throw {};
            } catch (c) {
                b = A.substitute, alert(b(this.commands.systemShortcut, [this.commands[a], b(this.commands[f("mac") ? "appleKey" : "ctrlKey"],
                    [{
                        cut: "X",
                        copy: "C",
                        paste: "V"
        ...
        _moveToBookmark: function(a) {
            ...
            a = a.isCollapsed;
            var d, e, k;
            c && (9 > f("ie") || 9 === f("ie") && f("quirks") ? h.isArray(c) ? (b = [], l.forEach(c, function(a) {
                    b.push(g.getNode(a, this.editNode))
        ...
        _getBookmark: function() {
            ...
            if (a && a.mark) {
                var c = a.mark;
                if (9 > f("ie") || 9 === f("ie") && f("quirks")) {
                    var d =
                        g.getSelection(this.window);
                    if (h.isArray(c)) l.forEach(a.mark, function(a) {
                        b.push(g.getIndex(a, this.editNode).o)
                    }, this), a.mark = b;
                    else if (d) {
                        var e;
                ...
                try {
                    a.mark && a.mark.startContainer && (b = g.getIndex(a.mark.startContainer, this.editNode).o, a.mark = {
                        startContainer: b,
                        startOffset: a.mark.startOffset,
                        endContainer: a.mark.endContainer === a.mark.startContainer ? b : g.getIndex(a.mark.endContainer, this.editNode).o,
        ...
        onKeyDown: function(a) {
            f("ie") || this.iframe || a.keyCode != d.TAB || this.tabIndent || this._saveSelection();
            if (this.customUndo) {
                var b = a.keyCode;
        ...
        _restoreSelection: function() {
            this._savedSelection && (delete this._cursorToStart, this.selection.isCollapsed() && this._moveToBookmark(this._savedSelection),

//>>built
define("dijit/_base/focus", "dojo/_base/array dojo/dom dojo/_base/lang dojo/topic dojo/_base/window ../focus ../selection ../main".split(" "), function(n, k, l, g, e, d, h, f) {
    d.focus = function(a) {
        if (a) {
            var b = "node" in a ? a.node : a,
                c = a.bookmark;
            a = a.openedForWindow;
            ...
            if (c && e.withGlobal(a || e.global, f.isCollapsed) && !h) {
                a && a.focus();
                try {
                    e.withGlobal(a || e.global, f.moveToBookmark,
                        null, [c])
                } catch (m) {}
            }
        }
    ...
    l.mixin(f, {
        ...
        getFocus: function(a, b) {
            ...
            return {
                node: c,
                bookmark: c && c == d.curNode && e.withGlobal(b || e.global, f.getBookmark),
                openedForWindow: b
            }
        },
        _activeStack: [],

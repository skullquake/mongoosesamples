...
define("dijit/_editor/plugins/AlwaysShowToolbar", "dojo/_base/declare dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/_base/lang dojo/on dojo/sniff dojo/_base/window ../_Plugin".split(" "), function(l, h, k, d, e, m, g, p, n) {
    return l("dijit._editor.plugins.AlwaysShowToolbar", n, {
        _handleScroll: !0,
        ...
        enable: function(b) {
            this._updateHeight();
            this.own(m(window, "scroll", e.hitch(this, "globalOnScrollHandler")), this.editor.on("NormalizedDisplayChanged",
                e.hitch(this, "_updateHeight")));
            return b
        },
        _updateHeight: function() {
            ...
            if (b.isLoaded && !b.height) {
                ...
                if (0 != a) {
                    ...
                    a != this._lastHeight && (this._lastHeight = a, d.setMarginBox(b.iframe, {
                        h: this._lastHeight
                    }))
                }
            }
        ...
        globalOnScrollHandler: function() {
            ...
            if (this._handleScroll) {
                ...
                var f = d.docScroll(this.editor.ownerDocument).y,
                    c = a.style;
                if (f > this._scrollThreshold && f < this._scrollThreshold + this._lastHeight) {
                    if (!this._fixEnabled) {
                        ...
                        b ? (c.left = d.position(a).x, this._IEOriginalPos = a.previousSibling ? ["after", a.previousSibling] : a.nextSibling ? ["before", a.nextSibling] : ["last", a.parentNode],
                            this.editor.ownerDocumentBody.appendChild(a), h.add(a, "dijitIEFixedToolbar")) : (c.position = "fixed", c.top = "0px");
                        d.setMarginBox(a, {
                            w: e.w
                        });
                        c.zIndex = 2E3;
                ...
                } else this._fixEnabled && (this.editor.iframe.style.marginTop = "", c.position = "", c.top = "", c.zIndex = "", c.display = "", b && (c.left = "", h.remove(a, "dijitIEFixedToolbar"), this._IEOriginalPos ? (k.place(a, this._IEOriginalPos[1], this._IEOriginalPos[0]),
                    this._IEOriginalPos = null) : k.place(a, this.editor.iframe, "before")), c.width = "", this._fixEnabled = !1)
            }
        },
        destroy: function() {

...
define("dijit/_editor/plugins/Print", "dojo/_base/declare dojo/i18n dojo/_base/lang dojo/sniff ../../focus ../_Plugin ../../form/Button dojo/i18n!../nls/commands".split(" "), function(h, k, e, f, l, d, m) {
    var g = h("dijit._editor.plugins.Print", d, {
        ...
        _print: function() {
            ...
            if (a.contentWindow.print)
                if (f("opera") || f("chrome")) {
                    var b = this.editor.document,
                        c = this.editor.get("value"),
                        c = "\x3chtml\x3e\x3chead\x3e\x3cmeta http-equiv\x3d'Content-Type' content\x3d'text/html; charset\x3d'UTF-8'\x3e\x3c/head\x3e\x3cbody\x3e" +
                        c + "\x3c/body\x3e\x3c/html\x3e",
                        a = window.open("javascript: ''", "", "status\x3d0,menubar\x3d0,location\x3d0,toolbar\x3d0,width\x3d1,height\x3d1,resizable\x3d0,scrollbars\x3d0");
                    a.document.open();
                    a.document.write(c);
                    a.document.close();
                    ...
                    a.print();
                    a.close()
                } else l.focus(a), a.contentWindow.print()
        }
    });

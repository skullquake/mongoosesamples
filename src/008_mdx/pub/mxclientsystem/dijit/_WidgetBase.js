...
define("dijit/_WidgetBase", "require dojo/_base/array dojo/aspect dojo/_base/config dojo/_base/connect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/_base/kernel dojo/_base/lang dojo/on dojo/ready dojo/Stateful dojo/topic dojo/_base/window ./Destroyable dojo/has!dojo-bidi?./_BidiMixin ./registry".split(" "), function(r, g, y, h, z, A, t, n, p, q, B, u, m, C, e, v, D, E, F, G, H, I, f) {
    ...
    h = A("dijit._WidgetBase", [E, H], {
        ...
        attributeMap: {},
        _blankGif: h.blankGif || r.toUrl("dojo/resources/blank.gif"),
        textDir: "",
        _introspect: function() {
            ...
            if (!a._setterAttrs) {
                ...
                for (d in b) /^on/.test(d) && (a[d.substring(2).toLowerCase()] = d), /^_set[A-Z](.*)Attr$/.test(d) && (d = d.charAt(4).toLowerCase() + d.substr(5, d.length - 9), b.attributeMap && d in b.attributeMap || c.push(d))
            }
        },
        ...
        create: function(a, b) {
            ...
            a && (this.params = a, e.mixin(this, a));
            this.postMixInProperties();
            this.id || (this.id = f.getUniqueId(this.declaredClass.replace(/\./g, "_")), this.params && delete this.params.id);
        ...
        _applyAttributes: function() {
            ...
            g.forEach(this.constructor._setterAttrs, function(b) {
                if (!(b in a)) {
                    var c = this._get(b);
                    c && this.set(b, c)
                }
        ...
        buildRendering: function() {
            ...
            if (this.baseClass) {
                ...
                this.isLeftToRight() || (a = a.concat(g.map(a, function(a) {
                    return a + "Rtl"
                })));
        ...
        postCreate: function() {},
        startup: function() {
            this._started || (this._started = !0, g.forEach(this.getChildren(), function(a) {
                a._started || a._destroyed || !e.isFunction(a.startup) || (a.startup(), a._started = !0)
            }))
        },
        ...
        destroy: function(a) {
            ...
            this._beingDestroyed = !0;
            this.uninitialize();
            g.forEach(this._connects, e.hitch(this, "disconnect"));
            g.forEach(this._supportingWidgets, b);
            this.domNode && g.forEach(f.findWidgets(this.domNode, this.containerNode), b);
        ...
        _setStyleAttr: function(a) {
            var b = this.domNode;
            e.isObject(a) ? u.set(b, a) : b.style.cssText = b.style.cssText ? b.style.cssText + ("; " + a) : a;
            this._set("style", a)
        },
        _attrToDom: function(a, b, c) {
            c = 3 <=
                arguments.length ? c : this.attributeMap[a];
            g.forEach(e.isArray(c) ? c : [c], function(c) {
                var d = this[c.node || c || "domNode"];
                switch (c.type || "attribute") {
                    case "attribute":
                        e.isFunction(b) && (b = e.hitch(this, b));
                        c = c.attribute ? c.attribute : /^on[A-Z][a-zA-Z]*$/.test(a) ? a.toLowerCase() : a;
                        d.tagName ? n.set(d, c, b) : d.set(c, b);
                        break;
                    case "innerText":
                        d.innerHTML = "";
        ...
        set: function(a, b) {
            ...
            var d = this[c.s];
            if (e.isFunction(d)) var g = d.apply(this, Array.prototype.slice.call(arguments, 1));
            else {
                var d = this.focusNode && !e.isFunction(this.focusNode) ? "focusNode" : "domNode",
        ...
        _set: function(a, b) {
            var c =
                this[a];
            this[a] = b;
            !this._created || c === b || c !== c && b !== b || (this._watchCallbacks && this._watchCallbacks(a, c, b), this.emit("attrmodified-" + a, {
                detail: {
                    prevValue: c,
                    newValue: b
                }
        ...
        getChildren: function() {
            return this.containerNode ? f.findWidgets(this.containerNode) : []
        },
        getParent: function() {
            return f.getEnclosingWidget(this.domNode.parentNode)
        },
        ...
        subscribe: function(a, b) {
            return this.own(F.subscribe(a, e.hitch(this, b)))[0]
        },
        ...
        placeAt: function(a, b) {
            var c = !a.tagName && f.byId(a);
            !c || !c.addChild || b && "number" !== typeof b ? (c = c && "domNode" in
                c ? c.containerNode && !/after|before|replace/.test(b || "") ? c.containerNode : c.domNode : t.byId(a, this.ownerDocument), q.place(this.domNode, c, b), !this._started && (this.getParent() || {})._started && this.startup()) : c.addChild(this, b);
            return this
        },
        defer: function(a, b) {
            var c = setTimeout(e.hitch(this, function() {
                c && (c = null, this._destroyed || e.hitch(this, a)())
            }), b || 0);
            return {
                remove: function() {

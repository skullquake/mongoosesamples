...
define("dijit/_PaletteMixin", "dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-construct dojo/keys dojo/_base/lang dojo/on ./_CssStateMixin ./a11yclick ./focus ./typematic".split(" "), function(p, e, f, n, q, l, r, t, u, g, v) {
    return p("dijit._PaletteMixin", t, {
        defaultTimeout: 500,
        timeoutChangeRate: .9,
        value: "",
        _selectedCell: -1,
        ...
        _preparePalette: function(a,
            b) {
            this._cells = [];
            var c = this._blankGif;
            this.own(r(this.gridNode, u, l.hitch(this, "_onCellClick")));
            for (var h = 0; h < a.length; h++)
                for (var g = n.create("tr", {
                        tabIndex: "-1",
                        role: "row"
                    }, this.gridNode), k = 0; k < a[h].length; k++) {
                    var d = a[h][k];
                    if (d) {
                        var e = this._dyeFactory(d, h, k, b[d]),
                            d = n.create("td", {
            ...
            var f = {
                ...
                m;
            for (m in f) this.own(v.addKeyListener(this.domNode, {
                keyCode: q[m],
                ctrlKey: !1,
                altKey: !1,
                shiftKey: !1

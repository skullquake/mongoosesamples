...
define("dijit/_CssStateMixin", "dojo/_base/array dojo/_base/declare dojo/dom dojo/dom-class dojo/has dojo/_base/lang dojo/on dojo/domReady dojo/touch dojo/_base/window ./a11yclick ./registry".split(" "), function(e, h, q, f, v, r, g, t, k, u, l, m) {
    h = h("dijit._CssStateMixin", [], {
        ...
        _setStateClass: function() {
            ...
            this.disabled ? a("Disabled") : this.readOnly ? a("ReadOnly") : this.active ?
                a("Active") : this.hovering && a("Hover");
            this.focused && a("Focused");
            var d = this.stateNode || this.domNode,
                c = {};
        ...
        _subnodeCssMouseEvent: function(a, b, d) {
            ...
            if (!this.disabled && !this.readOnly) switch (d.type) {
                case "mouseover":
                case "MSPointerOver":
                case "pointerover":
                    f.toggle(a,
    ...
    t(function() {
        function a(a,
            b, d) {
            if (!d || !q.isDescendant(d, b))
                for (; b && b != d; b = b.parentNode)
                    if (b._cssState) {
                        var c = m.getEnclosingWidget(b);
                        c && (b == c.domNode ? c._cssMouseEvent(a) : c._subnodeCssMouseEvent(b, b._cssState, a))
                    }
        }
        var b = u.body(),
            d;
        g(b, k.over, function(c) {
            a(c, c.target, c.relatedTarget)
        });
        g(b, k.out, function(c) {
            a(c, c.target, c.relatedTarget)
        });
        g(b, l.press, function(c) {
            d = c.target;
            a(c, d)
        });
        g(b, l.release, function(c) {
            a(c, d);
            d = null
        });
        g(b, "focusin, focusout", function(a) {
            var b = a.target;
            if (b._cssState && !b.getAttribute("widgetId")) {
                var c =
                    m.getEnclosingWidget(b);

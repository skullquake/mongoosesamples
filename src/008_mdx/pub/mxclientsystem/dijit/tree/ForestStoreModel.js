...
define("dijit/tree/ForestStoreModel", ["dojo/_base/array", "dojo/_base/declare", "dojo/_base/kernel", "dojo/_base/lang", "./TreeStoreModel"], function(e, g, h, f, k) {
    return g("dijit.tree.ForestStoreModel", k, {
        rootId: "$root$",
        rootLabel: "ROOT",
        query: null,
        ...
        getChildren: function(a, b, c) {
            a === this.root ? this.root.children ? b(this.root.children) :
                this.store.fetch({
                    query: this.query,
        ...
        getLabel: function(a) {
            return a === this.root ? this.root.label :
                this.inherited(arguments)
        },
        ...
        pasteItem: function(a, b, c, d, e) {
            if (b === this.root && !d) this.onLeaveRoot(a);

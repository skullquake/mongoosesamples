...
define("dijit/tree/TreeStoreModel", ["dojo/_base/array", "dojo/aspect", "dojo/_base/declare", "dojo/_base/lang"], function(h, l, m, f) {
    return m("dijit.tree.TreeStoreModel", null, {
        store: null,
        ...
        constructor: function(a) {
            ...
            a.getFeatures()["dojo.data.api.Notification"] &&
                (this.connects = this.connects.concat([l.after(a, "onNew", f.hitch(this, "onNewItem"), !0), l.after(a, "onDelete", f.hitch(this, "onDeleteItem"), !0), l.after(a, "onSet", f.hitch(this, "onSetItem"), !0)]))
        },
        destroy: function() {
        ...
        getChildren: function(a, b, c) {
            var g = this.store;
            if (g.isItemLoaded(a)) {
                for (var d = [], e = 0; e < this.childrenAttrs.length; e++) var n = g.getValues(a, this.childrenAttrs[e]),
                    d = d.concat(n);
                var k = 0;
        ...
        newItem: function(a, b, c) {
            var g = {
                ...
                d;
            this.newItemIdAttr &&
                a[this.newItemIdAttr] ? this.fetchItemByIdentity({
        ...
        pasteItem: function(a, b, c, g, d) {
            ...
            if (c)
                if ("number" == typeof d) {
                    ...
                    k.splice(d, 0, a);
                    e.setValues(c, f, k)
                } else e.setValues(c, f, e.getValues(c, f).concat(a))
        },
        onChange: function() {},
        ...
        onSetItem: function(a, b) {
            if (-1 != h.indexOf(this.childrenAttrs, b)) this.getChildren(a, f.hitch(this, function(b) {

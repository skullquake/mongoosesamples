...
define("dijit/tree/_dndSelector", "dojo/_base/array dojo/_base/declare dojo/_base/kernel dojo/_base/lang dojo/dnd/common dojo/dom dojo/mouse dojo/on dojo/touch ../a11yclick ./_dndContainer".split(" "), function(d, l, m, e, h, n, p, f, g, k, q) {
    return l("dijit.tree._dndSelector", q, {
        constructor: function() {
            this.selection = {};
            this.anchor = null;
            this.events.push(f(this.tree.domNode, g.press, e.hitch(this, "onMouseDown")), f(this.tree.domNode, g.release, e.hitch(this, "onMouseUp")), f(this.tree.domNode, g.move, e.hitch(this, "onMouseMove")),
                f(this.tree.domNode, k.press, e.hitch(this, "onClickPress")), f(this.tree.domNode, k.release, e.hitch(this, "onClickRelease")))
        },
        singular: !1,
        ...
        removeTreeNode: function(a) {
            var b =
                d.filter(this.getSelectedTreeNodes(), function(b) {
        ...
        _updateSelectionProperties: function() {
            ...
            this.tree._set("selectedNode", c[0] ||
                null);
        ...
        onClickRelease: function(a) {
            this._doDeselect &&
                (this._doDeselect = !1, this.userSelect("keyup" == a.type ? this.tree.focusedChild : this.current, h.getCopyKeyState(a), a.shiftKey))
        },
        ...
        userSelect: function(a, b, c) {
            if (this.singular) this.anchor == a && b ? this.selectNone() : (this.setSelection([a]), this.anchor = a);
                ...
                c.push(a);
                this.setSelection(c)
            } else this.selection[a.id] &&
                b ? this.removeTreeNode(a) : b ? this.addTreeNode(a, !0) : (this.setSelection([a]), this.anchor = a)
        },
        getItem: function(a) {
            return {

...
define("dijit/WidgetSet", ["dojo/_base/array", "dojo/_base/declare", "dojo/_base/kernel", "./registry"], function(e, k, f, l) {
    var g = k("dijit.WidgetSet", null, {
        ...
        forEach: function(a, b) {
            ...
            var d = 0,
                c;
            for (c in this._hash) a.call(b,
                this._hash[c], d++, this._hash);
            return this
        },
        filter: function(a, b) {
            b = b || f.global;
        ...
        byClass: function(a) {
            var b = new g,
                d, c;
            for (d in this._hash) c = this._hash[d], c.declaredClass == a && b.add(c);
            return b
        },
        toArray: function() {
            var a = [],
                b;
            for (b in this._hash) a.push(this._hash[b]);
            return a
        },
        map: function(a, b) {
        ...
        every: function(a, b) {
            ...
            var d = 0,
                c;
            for (c in this._hash)
                if (!a.call(b, this._hash[c], d++, this._hash)) return !1;
            return !0
        },
        some: function(a, b) {
            b = b || f.global;
            var d = 0,
                c;
            for (c in this._hash)
                if (a.call(b, this._hash[c], d++, this._hash)) return !0;
            return !1
        }
    });

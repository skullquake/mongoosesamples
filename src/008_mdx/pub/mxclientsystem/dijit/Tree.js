...
define("dijit/Tree", "dojo/_base/array dojo/aspect dojo/cookie dojo/_base/declare dojo/Deferred dojo/promise/all dojo/dom dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/errors/create dojo/fx dojo/has dojo/_base/kernel dojo/keys dojo/_base/lang dojo/on dojo/topic dojo/touch dojo/when ./a11yclick ./focus ./registry ./_base/manager ./_Widget ./_TemplatedMixin ./_Container ./_Contained ./_CssStateMixin ./_KeyNavMixin dojo/text!./templates/TreeNode.html dojo/text!./templates/Tree.html ./tree/TreeStoreModel ./tree/ForestStoreModel ./tree/_dndSelector dojo/query!css2".split(" "),
    function(e, p, z, A, r, t, m, l, B, u, K, C, v, w, U, d, k, L, D, M, E, N, q, F, G, H, I, O, J, P, Q, R, V, S, T) {
        function h(a) {
            return d.delegate(a.promise || a, {
        ...
        var y = A("dijit._TreeNode", [G, H, I, O, J], {
            item: null,
            isTreeNode: !0,
            label: "",
            ...
            _applyClassAndStyle: function(a, b, c) {
                ...
                b += "Node";
                var g = this[f];
                this[f] = this.tree["get" + c + "Class"](a, this.isExpanded);
                l.replace(this[b], this[f] || "", g || "");
            ...
            expand: function() {
                if (this._expandDeferred) return h(this._expandDeferred);
                ...
                var a = C.wipeIn({
                    ...
                    b = this._expandDeferred = new r(function() {
                        a.stop()
                    });
            ...
            collapse: function() {
                if (this._collapseDeferred) return h(this._collapseDeferred);
                ...
                var a = C.wipeOut({
                    ...
                    b = this._collapseDeferred = new r(function() {
                        a.stop()
                    });
                p.after(a, "onEnd",
                    function() {
            ...
            setChildItems: function(a) {
                ...
                this.defer(function() {
                    e.forEach(d, function(a) {
                        if (!a._destroyed && !a.getParent()) {
                            var f = function(a) {
                                var g = c.getIdentity(a.item),
                                    d = b._itemNodesMap[g];
                                1 == d.length ? delete b._itemNodesMap[g] : (g = e.indexOf(d, a), -1 != g && d.splice(g, 1));
                                e.forEach(a.getChildren(), f)
                            };
                ...
                a && 0 < a.length ? (this.isExpandable = !0, e.forEach(a, function(a) {
                    var g = c.getIdentity(a),
                        d = b._itemNodesMap[g],
                        e;
                    if (d)
                        for (var h = 0; h < d.length; h++)
                            if (d[h] && !d[h].getParent()) {
                                e = d[h];
                        ...
                        item: a,
                        tree: b,
                        isExpandable: c.mayHaveChildren(a),
                        label: b.getLabel(a),
                    ...
                    }), d ? d.push(e) : b._itemNodesMap[g] = [e]);
                    this.addChild(e);
                    (this.tree.autoExpand || this.tree._state(e)) && f.push(b._expandNode(e))
        ...
        var n = A("dijit.Tree", [G, P, H, J], {
            ...
            postCreate: function() {
                this._initState();
                var a = this;
                this.own(k(this.containerNode,
                    k.selector(".dijitTreeNode", D.enter),
                    function(b) {
                        a._onNodeMouseEnter(q.byNode(this), b)
                    }), k(this.containerNode, k.selector(".dijitTreeNode", D.leave), function(b) {
                    a._onNodeMouseLeave(q.byNode(this), b)
                }), k(this.containerNode, k.selector(".dijitTreeRow", E.press), function(b) {
                    a._onNodePress(q.getEnclosingWidget(this), b)
                }), k(this.containerNode, k.selector(".dijitTreeRow", E), function(b) {
                    a._onClick(q.getEnclosingWidget(this), b)
                }), k(this.containerNode, k.selector(".dijitTreeRow", "dblclick"), function(b) {
                    a._onDblClick(q.getEnclosingWidget(this),
                        b)
                }));
            ...
            _store2model: function() {
                ...
                this.params.getItemChildren &&
                    (a.getChildren = d.hitch(this, function(a, c, f) {
                        this.getItemChildren(this._v10Compat && a === this.model.root ? null : a, c, f)
                    }));
                this.model = new S(a);
            ...
            _load: function() {
                this.model.getRoot(d.hitch(this, function(a) {
                    ...
                    this.showRoot ? (this.domNode.setAttribute("aria-multiselectable",
            ...
            _setSelectedItemsAttr: function(a) {
                ...
                return this.pendingCommandsPromise = this.pendingCommandsPromise.always(d.hitch(this, function() {
                    ...
                    e.forEach(c, function(a) {
                        f = f.concat(b._itemNodesMap[a] || [])
                    });
                    this.set("selectedNodes", f)
                }))
            },
            _setPathAttr: function(a) {
                return a.length ? h(this.set("paths", [a]).then(function(a) {
                    return a[0]
                })) : h(this.set("paths", []).then(function(a) {
                    return a[0]
                }))
            },
            _setPathsAttr: function(a) {
                function b(a, d) {
                    var f = a.shift(),
                        g = e.filter(d, function(a) {
                            return a.getIdentity() == f
                        })[0];
                    if (g) return a.length ? c._expandNode(g).then(function() {
                        return b(a,
                            g.getChildren())
                    }) : g;
                ...
                var c = this;
                return h(this.pendingCommandsPromise = this.pendingCommandsPromise.always(function() {
                    return t(e.map(a, function(a) {
                        a = e.map(a, function(a) {
                            return a && d.isObject(a) ? c.model.getIdentity(a) : a
                        });
                        if (a.length) return b(a, [c.rootNode]);
            ...
            __click: function(a, b, c, d) {
                ...
                a.isExpandable && (c || e) ? this._onExpandoClick({
                    node: a
            ...
            _getRootOrFirstNode: function() {
                w.deprecated(this.declaredClass + "::_getRootOrFirstNode() is deprecated. Use _getFirst() instead.", "",
                    "2.0");
            ...
            _onItemDelete: function(a) {
                ...
                b && (e.forEach(b, function(a) {
                    ...
                    var b = a.getParent();
                    b && b.removeChild(a);
                    this.lastFocusedChild && !m.isDescendant(this.lastFocusedChild.domNode,
                        this.domNode) && delete this.lastFocusedChild;

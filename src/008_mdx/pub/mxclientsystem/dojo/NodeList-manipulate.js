...
define("dojo/NodeList-manipulate", "./query ./_base/lang ./_base/array ./dom-construct ./dom-attr ./NodeList-dom".split(" "), function(l, m, t, p, q) {
    ...
    m.extend(f, {
        _placeMultiple: function(a, b) {
            for (var c = "string" == typeof a || a.nodeType ? l(a) :
                    a, d = [], g = 0; g < c.length; g++)
                for (var e = c[g], f = this.length, h = f - 1, k; k = this[h]; h--) 0 < g && (k = this._cloneNode(k), d.unshift(k)), h == f - 1 ? p.place(k, e, b) : e.parentNode.insertBefore(k, e), e = k;
        ...
        text: function(a) {
            if (arguments.length) {
                for (var b = 0, c; c = this[b]; b++) 1 == c.nodeType && q.set(c, "textContent", a);
                return this
            }
            for (var d = "", b = 0; c =
                this[b]; b++) d += q.get(c, "textContent");
            return d
        },
        val: function(a) {
            if (arguments.length) {
                for (var b = m.isArray(a), c = 0, d; d = this[c]; c++) {
                    var g = d.nodeName.toUpperCase(),
                        e = d.type,
                        f = b ? a[c] : a;
                    if ("SELECT" == g)
                        ...
                        } else "checkbox" == e || "radio" == e ? d.checked = d.value == f : d.value = f
                }
                return this
            }
        ...
        wrapAll: function(a) {
            if (this[0]) {
                ...
                a = r(a);
                for (var b = 0, c; c = this[b]; b++) a.appendChild(c)
            }
            return this
        },
        wrapInner: function(a) {
            if (this[0]) {
                ...
                for (var b = 0; b < this.length; b++) {
                    ...
                    this._wrap(m._toArray(this[b].childNodes),
    ...
    f.prototype.html ||
        (f.prototype.html = f.prototype.innerHTML);
    return f
});
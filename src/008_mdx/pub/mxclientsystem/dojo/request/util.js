...
//>>built
define("dojo/request/util", "exports ../errors/RequestError ../errors/CancelError ../Deferred ../io-query ../_base/array ../_base/lang ../promise/Promise ../has".split(" "), function(f, q, m, r, n, t, h, u, v) {
    function w(b) {
        return p(b)
    }
    ...
    f.deferred = function(b, c, e, d, a, k) {
        ...
        g.isReady = d;
        g.handleResponse = a;
        e = g.then(w).otherwise(function(a) {
            a.response = b;
            throw a;
        });
    ...
    f.parseArgs = function(b, c, e) {
        var d = c.data,
            a = c.query;
        !d || e || "object" !== typeof d || v("native-xhr2") && (d instanceof ArrayBuffer || d instanceof Blob) || (c.data = n.objectToQuery(d));
        a ? ("object" ===
            typeof a && (a = n.objectToQuery(a)), c.preventCache && (a += (a ? "\x26" : "") + "request.preventCache\x3d" + +new Date)) : c.preventCache && (a = "request.preventCache\x3d" + +new Date);

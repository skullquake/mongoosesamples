...
define("dojo/NodeList-dom", "./_base/kernel ./query ./_base/array ./_base/lang ./dom-class ./dom-construct ./dom-geometry ./dom-attr ./dom-style".split(" "), function(k, g, w, l, n, m, p, q, x) {
    ...
    l.extend(e, {
            ...
            if (1 == b.nodeType || "only" != c)
                for (var h, g = a.length, e = g - 1; 0 <= e; e--) {
                    ...
                    if (a._runParse && k.parser && k.parser.parse)
                        for (h || (h = b.ownerDocument.createElement("div")), h.appendChild(f), k.parser.parse(h), f = h.firstChild; h.firstChild;) h.removeChild(h.firstChild);
        ...
        style: u(r(x), t),
        addClass: f(n.add),
        removeClass: f(n.remove),
        toggleClass: f(n.toggle),
        replaceClass: f(n.replace),
        empty: f(m.empty),
        removeAttr: f(q.remove),
        marginBox: v(p.getMarginBox),
        place: function(a, b) {
            var c = g(a)[0];
        ...
        addContent: function(a, b) {
            a =
                this._normalize(a, this[0]);
            for (var c = 0, d; d = this[c]; c++) a.length ? this._place(a, d, b, 0 < c) : m.empty(d);
            return this
        }
    });
    return e

...
//>>built
define("dojo/touch", "./_base/kernel ./aspect ./dom ./dom-class ./_base/lang ./on ./has ./mouse ./domReady ./_base/window".split(" "), function(G, x, y, q, H, g, m, n, z, d) {
    function k(a, c, b) {
        return v && b ? function(a, c) {
            return g(a, b, c)
        } : I ? function(b, d) {
            var l = g(b, c, function(l) {
                    d.call(this, l);
                    p = (new Date).getTime()
                }),
                f = g(b, a, function(l) {
                    (!p || (new Date).getTime() > p + 1E3) && d.call(this, l)
                });
            return {
                remove: function() {
                    l.remove();
    ...
    var u = 5 > m("ios"),
        v = m("pointer-events") || m("MSPointer"),
        e = function() {
            var a = {},
                c;
            for (c in {
                    ...
                    over: 1,
                    out: 1
                }) a[c] = m("MSPointer") ? "MSPointer" + c.charAt(0).toUpperCase() + c.slice(1) : "pointer" + c;
            return a
        }(),
        I = m("touch-events"),
        F, f, r = !1,
        t, B, C, D, E, w, p, h;
    m("touch") && (v ? z(function() {
        ...
        function a(a) {
            ...
            6 <=
                m("ios") && (b.touches = a.touches, b.altKey = a.altKey, b.changedTouches = a.changedTouches, b.ctrlKey = a.ctrlKey, b.metaKey = a.metaKey, b.shiftKey = a.shiftKey, b.targetTouches = a.targetTouches);
            return b
        }
        h = d.body();
        d.doc.addEventListener("touchstart", function(a) {
            ...
            var b = h;
            h = a.target;
            g.emit(b, "dojotouchout", {
                relatedTarget: h,
                bubbles: !0
            });
            g.emit(h, "dojotouchover", {
                relatedTarget: b,
                bubbles: !0
            });
        ...
        g(d.doc, "touchmove", function(c) {
            p = (new Date).getTime();
            var b = d.doc.elementFromPoint(c.pageX -
                (u ? 0 : d.global.pageXOffset), c.pageY - (u ? 0 : d.global.pageYOffset));
            b && (h !== b && (g.emit(h, "dojotouchout", {
                relatedTarget: b,
                bubbles: !0
            }), g.emit(b, "dojotouchover", {
                relatedTarget: h,
                bubbles: !0
            }), h = b), g.emit(b, "dojotouchmove", a(c)) || c.preventDefault())
        });
    ...
    x = {
        press: k("mousedown", "touchstart", e.down),
        move: k("mousemove",
            "dojotouchmove", e.move),
        release: k("mouseup", "dojotouchend", e.up),
        cancel: k(n.leave, "touchcancel", v ? e.cancel : null),
        over: k("mouseover", "dojotouchover", e.over),
        out: k("mouseout", "dojotouchout", e.out),
        enter: n._eventHandler(k("mouseover", "dojotouchover", e.over)),
        leave: n._eventHandler(k("mouseout", "dojotouchout", e.out))
    };
    return G.touch = x
});
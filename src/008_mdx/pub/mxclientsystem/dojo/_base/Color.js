...
//>>built
define("dojo/_base/Color", ["./kernel", "./lang", "./array", "./config"], function(c, e, g, k) {
    ...
    b.named = {
        ...
        teal: [0, 128, 128],
        aqua: [0, 255, 255],
        transparent: k.transparentColor || [0, 0, 0, 0]
    };
    e.extend(b, {
        r: 255,
        g: 255,
        ...
        setColor: function(a) {
            e.isString(a) ? b.fromString(a, this) : e.isArray(a) ? b.fromArray(a, this) : (this._set(a.r, a.g, a.b, a.a), a instanceof b || this.sanitize());
            return this
        },
        sanitize: function() {
            return this
    ...
    b.blendColors = c.blendColors = function(a, f, d, h) {
        var c = h || new b;

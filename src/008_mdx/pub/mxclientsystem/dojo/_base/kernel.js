...
define("dojo/_base/kernel", ["../has", "./config", "require", "module"], function(d, h, k, b) {
    ...
    var l;
    for (g = 0; l = b[g++];) console[l] ? d("console-as-object") && (console[l] = Function.prototype.bind.call(console[l], console)) : function() {
        var f = l + "";
    ...
    a.moduleUrl = function(b, c) {
        a.deprecated("dojo.moduleUrl()", "use require.toUrl",
            "2.0");
        var d = null;

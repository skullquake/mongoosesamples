    ...
    var f = {
        ...
        getTimezoneName: function(b) {
            var a = b.toString(),
                c = "",
                e = a.indexOf("(");
            if (-1 < e) c = a.substring(++e, a.indexOf(")"));
            else if (e = /([A-Z\/]+) \d{4}$/, a = a.match(e)) c = a[1];
            else if (a = b.toLocaleString(), e = / ([A-Z\/]+)$/, a = a.match(e)) c = a[1];
            return "AM" == c ||
                "PM" == c ? "" : c
        },
        ...
        difference: function(b, a, c) {
            a = a || new Date;
            c = c || "day";
            var e = a.getFullYear() - b.getFullYear(),
                d = 1;
            switch (c) {
                case "quarter":
                    b = b.getMonth();

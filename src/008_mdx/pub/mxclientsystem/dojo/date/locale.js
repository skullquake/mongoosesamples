define([
    ...
    function formatPattern(dateObject, bundle, options, pattern) {
        return pattern.replace(/([a-z])\1*/ig, function(match) {
            ...
            switch (c) {
                ...
                case 'y':
                case 'Y':
                    s = c === "y" ? dateObject.getFullYear() : window.dojo.getWeekNumber(dateObject).year;
                    switch (l) {
                        case 1:
                            break;
                        case 2:
                ...
                case 'Z':
                    ...
                    s = tz.join("");
                    break;
                    //				case 'u': case 'W': case 'F': case 'g': case 'A':
    ...
    exports._getWeekOfYear = function( /*Date*/ dateObject) {
        return window.dojo.getWeekNumber(dateObject).week;
    };

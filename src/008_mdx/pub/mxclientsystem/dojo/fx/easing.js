...
define("dojo/fx/easing", ["../_base/lang"], function(d) {
    var b = {
        ...
        expoInOut: function(a) {
            ...
            if (1 == a) return 1;
            a *= 2;
            if (1 > a) return Math.pow(2, 10 * (a - 1)) / 2;
            --a;
        ...
        backInOut: function(a) {
            a *= 2;
            if (1 > a) return Math.pow(a, 2) * (3.5949095 * a - 2.5949095) / 2;
            a -= 2;
        ...
        elasticInOut: function(a) {
            ...
            var b = .3 * 1.5,
                c = b / 4;
            if (1 > a) return --a, -.5 * Math.pow(2, 10 * a) * Math.sin(2 * (a - c) * Math.PI / b);
            --a;
            return .5 *
                Math.pow(2, -10 * a) * Math.sin(2 * (a - c) * Math.PI / b) + 1
        },
        bounceIn: function(a) {

    ...
    var p = 0,
        e = {
            ...
            _setNodeContent: function(a, b) {
                ...
                if (b)
                    if ("number" == typeof b && (b = b.toString()), "string" == typeof b && (b = f.toDom(b, a.ownerDocument)), !b.nodeType && g.isArrayLike(b))
                        for (var c = b.length, d = 0; d < b.length; d = c == b.length ?
                            d + 1 : 0) f.place(b[d], a, "last");
            ...
            set: function(a, b, c) {
                ...
                return c ? (new e._ContentSetter(g.mixin(c, {
                        content: b,
                        node: a
                    }))).set() :
                    e._setNodeContent(a, b, !0)
            }
        };

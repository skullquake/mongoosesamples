    ...
    var h = p("dojo.dnd.Selector", v, {
        ...
        getSelectedNodes: function() {
            var b = new u,
                a = e._empty,
                c;
            for (c in this.selection) c in a || b.push(f.byId(c));
            return b
        },
        selectNone: function() {
        ...
        forInSelectedItems: function(b, a) {
            ...
            var c = this.selection,
                d = e._empty,
                g;
            for (g in c) g in d || b.call(a, this.getItem(g), g, this)
        },
        sync: function() {
            ...
            var b = [],
                a = e._empty,
                c;
            for (c in this.selection) c in a || this.getItem(c) || b.push(c);
        ...
        onMouseDown: function(b) {
            ...
            if (this.current)
                if (!this.singular && !e.getCopyKeyState(b) && !b.shiftKey && this.current.id in this.selection) this.simpleSelection = !0, t.isLeft(b) && (b.stopPropagation(), b.preventDefault());
                else {
                    if (!this.singular && b.shiftKey) {
                        ...
                        if (a.length && (this.anchor || (this.anchor = a[0], this._addItemClass(this.anchor, "Anchor")), this.selection[this.anchor.id] = 1, this.anchor != this.current)) {
                            for (var c =
                                    0, d; c < a.length && (d = a[c], d != this.anchor && d != this.current); ++c);
                            for (++c; c < a.length; ++c) {
                                d = a[c];
                    ...
                    } else this.singular ? this.anchor == this.current ? e.getCopyKeyState(b) && this.selectNone() : (this.selectNone(), this.anchor = this.current, this._addItemClass(this.anchor, "Anchor"), this.selection[this.current.id] = 1) : e.getCopyKeyState(b) ? this.anchor ==
                        this.current ? (delete this.selection[this.anchor.id], this._removeAnchor()) : this.current.id in this.selection ? (this._removeItemClass(this.current, "Selected"), delete this.selection[this.current.id]) : (this.anchor && (this._removeItemClass(this.anchor, "Anchor"), this._addItemClass(this.anchor, "Selected")), this.anchor = this.current, this._addItemClass(this.current, "Anchor"), this.selection[this.current.id] = 1) : this.current.id in this.selection || (this.selectNone(), this.anchor = this.current, this._addItemClass(this.current,
                            "Anchor"), this.selection[this.current.id] = 1);
                    b.stopPropagation();
                    b.preventDefault()
                }
        },
        ...
        onOutEvent: function() {
            this.onmousemoveEvent && (this.onmousemoveEvent.remove(),

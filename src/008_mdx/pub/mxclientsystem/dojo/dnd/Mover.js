    ...
    return n("dojo.dnd.Mover", [t], {
        constructor: function(a, b, d) {
            ...
            this.events = [c(a, h.move, e.hitch(this, "onFirstMove")),
                c(a, h.move, e.hitch(this, "onMouseMove")), c(a, h.release, e.hitch(this, "onMouseUp")), c(a, "dragstart", f), c(a.body, "selectstart", f)
            ];
            l.autoScrollStart(a);
        ...
        onFirstMove: function(a) {
            ...
            switch (b.position) {
                ...
                default:
                    ...
                    d = p.doc.body;
                    var c = r.getComputedStyle(d),
                        e = g.getMarginBox(d, c),
                        c = g.getContentBox(d, c);
                    d = b.l - (c.l - e.l);
                    b = b.t - (c.t - e.t)
            }

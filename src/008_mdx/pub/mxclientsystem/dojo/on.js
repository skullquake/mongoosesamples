...
define("dojo/on", ["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./sniff"], function(y, z, f) {
    ...
    g.matches = function(a, c, b, d, e) {
        ...
        for (; !e.matches(a, c, b);)
            if (a == b || !1 === d || !(a = a.parentNode) || 1 != a.nodeType) return !1;
        return a
    };
    g.selector = function(a, c, b) {
        return function(d, e) {
            ...
            var m = "function" == typeof a ? {
                    matches: a
                } : this,
                h = c.bubble;
            return h ? g(d, h(f), e) : g(d, c, function(a) {
                var b = f(a.target);
    ...
    var E = [].slice,
        F = g.emit = function(a, c, b) {
            ...
            do a[e] && a[e].apply(a, d); while (b && b.bubbles && (a =
                    a.parentNode));
    ...
    if (!f("event-stopimmediatepropagation")) var G = function() {
    ...
    if (f("dom-addeventlistener")) g.emit = function(a, c, b) {
        ...
        g._fixEvent = function(a, c) {
            ...
            if (!a.target) switch (a.target = a.srcElement, a.currentTarget = c || a.srcElement, "mouseover" == a.type && (a.relatedTarget = a.fromElement), "mouseout" == a.type && (a.relatedTarget = a.toElement), a.stopPropagation || (a.stopPropagation = H, a.preventDefault =
                I), a.type) {
                case "keypress":
            ...
            r = function(a,
                ...
                if (((a.ownerDocument ? a.ownerDocument.parentWindow : a.parentWindow || a.window || window) != top || 5.8 > f("jscript")) && !f("config-_allow_leaks")) {
                    ...
                    if (!d || !d.listeners) {
                        ...
                        a[c] = d;
                        d.global = this;
                        e && d.listeners.push(_dojoIEListeners_.push(e) -
                            1)
                    }
        ...
        n = function(a) {
            return function(c) {
                ...
                if (!b) {
                    ...
                    if (c.type) {
                        if (f("touch-can-modify-event-delegate")) w.prototype =
                            c, b = new w;
                        else {
                            var b = {},
                                e;
